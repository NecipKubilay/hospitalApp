...
namespace HospitalApp.Forms
{
    public partial class frmHastaEkle : Form
    {
        ...
        {
            SqlCommand komut = new SqlCommand("Insert into Hasta(HastaTc, HastaAd, HastaSoyad, HastaTelefon, HastaCinsiyet,HastaDogumTarihi,SekreterID) Values (@tc,@ad,@soyad,@telefon, @cinsiyet,@dogumtarih,@ID)", baglan.baglanti());
